...
// import homeBanner from './assets/banner.svg';
// import homePool from './assets/pool.svg';
// import homeGarden from './assets/garden.svg';
// import homePanel from './assets/panel.svg';
...
//           </div>
//         </div>
//         {/* <div className="w-full lg:w-[680px] h-[200px] lg:h-[360px] rounded-3xl ${homeBanner} bg-cover bg-center mt-8 lg:mt-0"></div> */}
//         <div
//           className={`w-full lg:w-[680px] h-[200px] lg:h-[360px] rounded-3xl ${homeBanner} bg-cover bg-center mt-8 lg:mt-0`}
//         ></div>
//       </section>
